	<!-- Upload Map Modal -->
	<div class="modal fade" id="surveyLP2bModal" tabindex="-1" role="dialog" aria-labelledby="surveyLP2bModal" aria-hidden="true">
			...
			<div class="modal-content rounded-20 border-0">
				<div class="modal-body p-4 pt-5 pb-4 p-md-5">
					...
					<div class="text-center">
						<h1 class="h2 text-gray-900 mb-2 fw-bold">Survey LP2B</h1>
